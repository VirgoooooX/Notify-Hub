...
const mobileComponent = () => import('@/views/MobileRemindersView.vue')
const routes = [
  { path: '/login', component: () => import('@/views/LoginView.vue'), meta: { public: true } },
  {
    path: '/m/reminders/new',
    name: 'mobile-reminder-new',
    component: mobileComponent,
    meta: { public: true },
  },
  {
    path: '/m/reminders/active',
    name: 'mobile-reminders-active',
    component: mobileComponent,
    meta: { public: true },
  },
  {
    path: '/m/reminders/:id',
    name: 'mobile-reminder-detail',
    component: mobileComponent,
    meta: { public: true },
  },
  {
    ...
    children: [
      ...
      { path: 'reminders', name: 'reminders', component: () => import('@/views/RemindersView.vue'), meta: { title: '提醒与催办' } },
      { path: 'reminders/:id', name: 'reminder-detail', component: () => import('@/views/ReminderDetailView.vue'), meta: { title: '催办时间线' } },
