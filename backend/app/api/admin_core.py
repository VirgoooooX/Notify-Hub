...
def client_view(client: ApiClient) -> dict[str, object]:
    return {
        ...
        "allow_reminders": client.allow_reminders,
        "allow_recurring": client.allow_recurring,
        "allow_cron": client.allow_cron,
        "allow_interactive": client.allow_interactive,
        "allow_mp_browser": client.allow_mp_browser,
        "max_active_reminders": client.max_active_reminders,
...
async def create_client(
    ...
    client = ApiClient(
        ...
        allow_reminders=payload.allow_reminders,
        allow_recurring=payload.allow_recurring,
        allow_cron=payload.allow_cron,
        allow_interactive=payload.allow_interactive,
        allow_mp_browser=payload.allow_mp_browser,
        max_active_reminders=payload.max_active_reminders,
